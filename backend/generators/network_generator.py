"""
===============================================================================
Harbinger: Network Degradation Signal Generator

Purpose
-------
Generates synthetic network degradation signals for distributed AI training
workloads using a three-layer Markov-based degradation model. The generator
simulates network state transitions, their impact on effective GPU throughput,
and produces synthetic telemetry for Harbinger's training dataset.
...
---------------
- total_minutes : int
    Total duration of the simulated workload in minutes.
...
Repository Files
----------------
- outputs/network_sample.csv
- outputs/network_plot.png

Returned Values
---------------
generate_network_degradation(...)
    Returns a pandas DataFrame containing:
    - Minute
    - Network_State
    - Network_Impact_Factor
    - Nominal_GPU_Util
    - Effective_Throughput

Functions
---------
generate_network_degradation(total_minutes)
    Simulates stochastic network degradation using Markov state transitions
    and computes the resulting effective GPU throughput.

Model
-----
3-Layer Network Degradation Model

Model Components
----------------
Layer 1 : Network State Definition
Layer 2 : Markov State Transition
Layer 3 : Performance Impact Calculation

Pipeline Role
-------------
Synthetic signal generator responsible for producing network-related telemetry
used during synthetic dataset construction by build_training_dataset.py.
The generated signals contribute to downstream feature engineering,
baseline evaluation, and Harbinger decision modelling.
===============================================================================
"""
